...
max_token_id = wordToken.load_file_list(['./questions.txt', './answers.txt'], min_freq)
...
def get_train_set():
    ...
    with open('./questions.txt', 'r', encoding='UTF-8') as question_file:
        with open('.answers.txt', 'r', encoding='UTF-8') as answer_file:
            while True:
    ...
    with tf.Session() as sess:
        ...
        for step in range(1000000):
            ...
            if step % 10 == 0:
                ...
                # 模型持久化
                saver.save(sess, './model/chatbotmod')
...
def predict():
    ...
    with tf.Session() as sess:
        ...
        saver.restore(sess, './model/chatbotmod')
        sys.stdout.write("> ")
        sys.stdout.flush()
